 ...
 */
export const INDIA_VIEWBOX = "-64 -10 362.3 330";
...
export const WAYPOINTS: Waypoint[] = [
  { name: "Kozhikode", year: "1977", note: "Born", x: 80.5, y: 280.3, labelSide: "right" },
  { name: "Bengaluru", year: "1977–95", note: "Raised & schooled", x: 98.3, y: 262.0, labelSide: "right" },
  { name: "NDA, Khadakwasla", year: "1995", note: "Joined the Academy", x: 60.9, y: 203.6, labelSide: "left" },
  { name: "IMA, Dehradun", year: "1999", note: "Commissioned, 7 Bihar", x: 102.6, y: 77.9, labelSide: "right" },
  { name: "Siachen / Kargil", year: "1999", note: "Op Vijay & Siachen", x: 93.6, y: 23.8, labelSide: "right" },
  { name: "Mumbai, Taj Hotel", year: "2008", note: "Operation Black Tornado", x: 51.6, y: 198.9, labelSide: "left" },
];
